...
class QualityGateEngine:
    ...
    def __init__(
        self,
        registry_path: str = "models/registry/model_registry.json",
    ...
    def evaluate_candidate(
        ...
        """
        cand_roc = candidate_metrics.get("roc_auc", 0.0)
