...
class ModelPredictor:
    ...
    def __init__(self, model_path: Union[str, Path] = "models/artifacts/champion_pipeline.pkl"):
        ...
        # If user passed an absolute path, keep it; otherwise resolve against project root
    ...
    def load_model(self):
        ...
        if not self.model_path.exists():
            ...
            # Fallback list for common trained model names
            fallbacks = [
            ...
            if not found_fallback:
                raise FileNotFoundError(
                    ...
                    "Please run baseline model comparison or training first."
                )
    ...
    def predict(self, customer_data: Union[Dict[str, Any], pd.DataFrame]) -> Dict[str, Any]:
        ...
        # ----------------------------------------------------
        # CLEANSE PAYLOAD FOR MODEL PIPELINE
        # ----------------------------------------------------
